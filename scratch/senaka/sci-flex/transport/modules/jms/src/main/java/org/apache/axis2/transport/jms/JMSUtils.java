...
public class JMSUtils extends BaseUtils {
    ...
    /**
     * Gets payload of JMS MapMessage as a Map.
     * @param message the JMS Message
     * @return payload of JMS MapMessage as a Map.
     */
    ...
    /**
     * Return the body length in bytes for a map message
     * @param mMsg the JMS MapMessage
     * @return length of body in bytes
     */
